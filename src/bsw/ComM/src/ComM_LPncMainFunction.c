...
/*****************************************************************************************************
 * Function name    : ComM_LSetbit
 * Syntax           : ComM_LSetbit
 *                    (
 *                    uint8 PncId, P2VAR(uint8, AUTOMATIC,COMM_APPL_DATA) PnTxSignalVal_u8
 *                    )
 * Description      : Internal funtion to set signal value in an uint8 array
 * Parameters       : PncId -> Configured PncId.
 *                  : PnTxSignalVal_u8 -> Unit_8 Array
 * Return value     : void
 ****************************************************************************************************/
...
/*****************************************************************************************************
 * Function name    : ComM_LResetbit
 * Syntax           : ComM_LResetbit
 *                    (
 *                    uint8 PncId, P2VAR(uint8, AUTOMATIC,COMM_APPL_DATA) PnTxSignalVal_u8
 *                    )
                                        ...
                                        )
{
    ...
    /* TODO : document why lock is not required and why this order,ActiveERACnt_u8 and ERACnt_u8 */
                                                    ...
                                                    )
{
    ...
    if(previousPncState_e != COMM_PNC_PREPARE_SLEEP)
    {
        ...
        /* TODO :Timer generation is currently is milli seconds, this has to be changed to number of main functions
         * depending on PNC main function period */
