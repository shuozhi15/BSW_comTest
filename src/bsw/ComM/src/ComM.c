...
/* ComM_LProcessLimitToNoCom */
/**************************************************************************************
 * Function name    : ComM_LProcessLimitToNoCom
 * Syntax           : ComM_LProcessLimitToNoCom
 *                    (
 *                     VAR(NetworkHandleType, COMM_VAR) Channel,VAR(boolean, COMM_VAR) Status
 *                    )
 * Description      : Internal function to set limit to NoCom based on the current state of the Channel
...
/*****************************************************************************************************
 * Function name    : ComM_LGetbit
 * Syntax           : ComM_LGetbit
 *                    (
 *                    uint8 PncId, VAR(uint8, AUTOMATIC) Signal_Array[8]
 *                    )
 * Description      :
 * Parameters       : PncId -> Id of PNC
 *                  : Signal_Array[8] -> Array where Calculated data needs to be copied
