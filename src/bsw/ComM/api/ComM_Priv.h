...
/*typedef struct {
   ...
   VAR(uint8,COMM_VAR)                          ComMNoWakeup_u8[COMM_NVM_NO_WAKEUP_SIZE] ; Hols the ComMNowakeup value of all channels, which has to be written to NvM
} ComM_NvMStorageType;
*/
...
/*Internal funtion to set Limit to No Com for Channel based on the Current state*/
