...
#define         ComMConf_ComMChannel_ComMChannel_Can_NCluster_Channel       ((NetworkHandleType)0)
...
#define     ComMConf_ComMUser_ComMUser_Can_NCluster_Channel        ((ComM_UserHandleType)(0))
