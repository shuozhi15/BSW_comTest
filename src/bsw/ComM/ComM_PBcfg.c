...
static CONST(uint8, COMM_CONST) ComM_DirectUsersPerChannel_ComMChannel_Can_Cluster_Channel[] = {
ComMConf_ComMUser_ComMUser_Can_Cluster_Channel};

#endif


static CONST(uint8, COMM_CONST) ComM_AllUsersPerChannel_ComMChannel_Can_Cluster_Channel[] = {
    ComMConf_ComMUser_ComMUser_Can_Cluster_Channel    };
...
CONST(ComM_ChannelType,COMM_CONST) ComM_ChanelList[] = {
{
    ...
    /* Channel : ComMChannel_Can_Cluster_Channel */
#if ((COMM_INHIBITION_ENABLED) &&(COMM_PNC_ENABLED != STD_OFF))
    NULL_PTR,
#endif /* ((COMM_INHIBITION_ENABLED) &&(COMM_PNC_ENABLED != STD_OFF))  */
#if (COMM_INHIBITION_ENABLED)
    ComM_DirectUsersPerChannel_ComMChannel_Can_Cluster_Channel,
#endif /*#if (COMM_INHIBITION_ENABLED)  */
    ComM_AllUsersPerChannel_ComMChannel_Can_Cluster_Channel,
    COMM_BUS_TYPE_CAN,
    NONE,
...
static CONST(uint8,COMM_CONST) ComM_DirectChannelsPerUser_ComMUser_Can_Cluster_Channel[] = {
    ComMConf_ComMChannel_ComMChannel_Can_Cluster_Channel    
};
...
{
{
    ComM_DirectChannelsPerUser_ComMUser_Can_Cluster_Channel,
#if (COMM_PNC_ENABLED != STD_OFF)
    NULL_PTR,
#endif /* #if (COMM_PNC_ENABLED != STD_OFF)  */
    1,
