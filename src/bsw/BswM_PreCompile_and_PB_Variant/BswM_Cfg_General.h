...
#define BSWM_RB_COM_ENABLED             (FALSE)    
...
#define BSWM_GENERIC_REQUEST_ENABLED    (FALSE)
...
#define BSWM_NVM_ENABLED                (FALSE)

#define BSWM_SCHM_ENABLED                (FALSE)

#define BSWM_SD_ENABLED                 (FALSE)

#define BSWM_RB_COMMPNC_ENABLED         (TRUE)

#define BSWM_RB_INTRPTQUEUE_MAXSIZE     (1)
