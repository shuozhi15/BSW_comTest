...
#include "EcuM_Cfg_MemMap.h"
 ...
 static VAR(boolean, ECUM_VAR_CLEARED_BOOLEAN) EcuM_Prv_ShutDownflgCoresStopped;
 static VAR(boolean, ECUM_VAR_CLEARED_BOOLEAN) EcuM_Prv_ShutDownflgCoresTimeout;
...
static FUNC(void, ECUM_CODE)EcuM_Prv_ReportCheckWakeupError ( void );
...
/***********************************************************************************
  ...
  Remarks       :
 ************************************************************************************/
FUNC(boolean, ECUM_CODE)EcuM_Prv_CheckWakeupTimerHandling ( void )
         {
     VAR(uint8, AUTOMATIC) ctrLoop1_u8 = 0;
     VAR(EcuM_Prv_SleepStatus_ten, AUTOMATIC) flgExitSleep_u8 = ENTER_SLEEP_E;
     VAR(EcuM_Cfg_CheckWakeupSrc_tst, AUTOMATIC) dataCheckWakeupTimer_ast[ECUM_NUM_OF_WKP_SOURCES];
...
static FUNC(void, ECUM_CODE)EcuM_Prv_ReportCheckWakeupError ( void )
        {
    /*Local variable to hold sleep mode and intiliazed with invalid value*/
    VAR(EcuM_Prv_SleepType_Enum_ten, AUTOMATIC) dataSleepType_en = ECUM_PRV_NO_SLEEP_E;
...
static FUNC( Std_ReturnType , ECUM_CODE ) EcuM_Prv_ShutdownSynchronization( void )
 {
    ...
    VAR(EcuM_Prv_WakeupRestartReason_Enum_ten, AUTOMATIC)  stWakeupRestartReason_en = ECUM_PRV_NORMAL_E;
