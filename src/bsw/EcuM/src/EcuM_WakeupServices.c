...
FUNC( void, ECUM_CODE ) EcuM_SetWakeupEvent( VAR(EcuM_WakeupSourceType, AUTOMATIC) sources )
{
    ...
    VAR(EcuM_Prv_SleepType_Enum_ten, AUTOMATIC)     id_RequestedSleepType_en = ECUM_PRV_NO_SLEEP_E;
...
/**********************************************************************************
  ...
  Remarks           :
***********************************************************************************/
FUNC(void, ECUM_CODE) EcuM_EndCheckWakeup(VAR(EcuM_WakeupSourceType, AUTOMATIC) sources)
{
#if ECUM_SLEEP_SUPPORT_ENABLE
