...
extern volatile VAR( boolean, ECUM_VAR_CLEARED_BOOLEAN ) EcuM_Prv_PollSlaveCoreContinue_b;
...
extern FUNC(boolean, ECUM_CODE)EcuM_Prv_CheckWakeupTimerHandling ( void );
#endif// ECUM_SLEEP_SUPPORT_ENABLE
