...
static CONST(PduR_RT_UpToLo,PDUR_CONST ) PduR_comToLo[] = {
    { CanIfConf_CanIfTxPduCfg_BMS_20_Can_Network_CANNODE_0 , (PduR_loTransmitFP)PduR_RF_CanIf_Transmit, (PduR_loCancelTransmitFP)PduR_IH_CancelTransmit },    /*BMS_20_Can_Network_CANNODE_0_Com2PduR*/
    { CanIfConf_CanIfTxPduCfg_BMS_Vol_8_Can_Network_CANNODE_0 , (PduR_loTransmitFP)PduR_RF_CanIf_Transmit, (PduR_loCancelTransmitFP)PduR_IH_CancelTransmit }    /*BMS_Vol_8_Can_Network_CANNODE_0_Com2PduR*/
...
static CONST( PduR_RT_LoIfRxToUp, PDUR_CONST ) PduR_CanIfRxToUp[] = {        
    { ComConf_ComIPdu_OBC_1_Can_Network_CANNODE_0, (PduR_upIfRxIndicationFP) PduR_RF_Com_RxIndication },   /*OBC_1_Can_Network_CANNODE_0_CanIf2PduR*/        
    { ComConf_ComIPdu_TMR_3_Can_Network_CANNODE_0, (PduR_upIfRxIndicationFP) PduR_RF_Com_RxIndication }    /*TMR_3_Can_Network_CANNODE_0_CanIf2PduR*/
 };
...
{ ComConf_ComIPdu_BMS_20_Can_Network_CANNODE_0 , (PduR_upIfTxConfirmationFP) PduR_RF_Com_TxConfirmation} ,   /* Index: 0  SrcPdu: BMS_20_Can_Network_CANNODE_0_Com2PduR  DestPdu: BMS_20_Can_Network_CANNODE_0_PduR2CanIf*/
{ ComConf_ComIPdu_BMS_Vol_8_Can_Network_CANNODE_0 , (PduR_upIfTxConfirmationFP) PduR_RF_Com_TxConfirmation}     /* Index: 1  SrcPdu: BMS_Vol_8_Can_Network_CANNODE_0_Com2PduR  DestPdu: BMS_Vol_8_Can_Network_CANNODE_0_PduR2CanIf*/
};
