...
static CONST(PduR_RT_UpToLo,PDUR_CONST ) PduR_comToLo[] = {
    { CanIfConf_CanIfTxPduCfg_BMS_Tem_5_Can_Network_CANNODE_0 , (PduR_loTransmitFP)PduR_RF_CanIf_Transmit, (PduR_loCancelTransmitFP)PduR_IH_CancelTransmit }    /*BMS_Tem_5_Can_Network_CANNODE_0_Com2PduR*/
...
static CONST( PduR_RT_LoIfRxToUp, PDUR_CONST ) PduR_CanIfRxToUp[] = {        
    { ComConf_ComIPdu_OBC_4_Can_Network_CANNODE_0, (PduR_upIfRxIndicationFP) PduR_RF_Com_RxIndication }    /*OBC_4_Can_Network_CANNODE_0_CanIf2PduR*/
 };
...
{ ComConf_ComIPdu_BMS_Tem_5_Can_Network_CANNODE_0 , (PduR_upIfTxConfirmationFP) PduR_RF_Com_TxConfirmation}     /* Index: 0  SrcPdu: BMS_Tem_5_Can_Network_CANNODE_0_Com2PduR  DestPdu: BMS_Tem_5_Can_Network_CANNODE_0_PduR2CanIf*/
};
