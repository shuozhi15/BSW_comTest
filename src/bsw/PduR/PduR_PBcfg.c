...
static CONST(PduR_RT_UpToLo,PDUR_CONST ) PduR_comToLo[] = {
    { CanIfConf_CanIfTxPduCfg_BMS_14_Can_Network_CANNODE_0 , (PduR_loTransmitFP)PduR_RF_CanIf_Transmit, (PduR_loCancelTransmitFP)PduR_IH_CancelTransmit }    /*BMS_14_Can_Network_CANNODE_0_Com2PduR*/
...
{ ComConf_ComIPdu_BMS_14_Can_Network_CANNODE_0 , (PduR_upIfTxConfirmationFP) PduR_RF_Com_TxConfirmation}     /* Index: 0  SrcPdu: BMS_14_Can_Network_CANNODE_0_Com2PduR  DestPdu: BMS_14_Can_Network_CANNODE_0_PduR2CanIf*/
};
