 ...
 *  P2VAR(PduInfoType,TYPEDEF,PDUR_APPL_DATA) infoPtr;  Store info of Pdu at the time of StartOfreception\n
 *  #endif  \n
 ...
 * P2VAR( uint8, TYPEDEF, PDUR_VAR ) begin;             starting address \n
 * P2CONST( PduR_DefaultValues_fixed, TYPEDEF, PDUR_CONST )            defaultValueElement;  default values of buffer\n
 ...
 * typedef struct \n
 *  { \n
 *      P2VAR( uint8, TYPEDEF, PDUR_VAR )       begin;      starting address of the destination GW buffer \n
 *      P2CONST( PduR_DefaultValues_fixed, TYPEDEF, PDUR_CONST )            defaultValueElement;        default \n
 *      values of buffer\n
 *      uint8                                   defaultValueSize;        Total number of byte positions to be filled\n
 ...
 *      P2CONST( PduR_DefaultValue_Info, TYPEDEF, PDUR_CONST ) defaultValue_info; Information on Default values of \n
