...
#define PduRConf_PduRSrcPdu_BMS_14_Can_Network_CANNODE_0_Com2PduR    0
#define PduRConf_PduRDestPdu_BMS_14_Can_Network_CANNODE_0_PduR2CanIf  0

#define PduRConf_PduRSrcPdu_TMR_3_Can_Network_CANNODE_0_CanIf2PduR    0
