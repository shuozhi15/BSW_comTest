...
#define PduRConf_PduRSrcPdu_BMS_Tem_5_Can_Network_CANNODE_0_Com2PduR    0
#define PduRConf_PduRDestPdu_BMS_Tem_5_Can_Network_CANNODE_0_PduR2CanIf  0

#define PduRConf_PduRSrcPdu_OBC_4_Can_Network_CANNODE_0_CanIf2PduR    0
