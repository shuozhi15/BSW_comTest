...
#define PduRConf_PduRSrcPdu_BMS_Vol_5_CANNODE_0_Com2PduR    0
#define PduRConf_PduRDestPdu_BMS_Vol_5_CANNODE_0_PduR2CanIf  0

#define PduRConf_PduRSrcPdu_OBC_4_CANNODE_0_CanIf2PduR    0

#define PduRConf_PduRSrcPdu_TMR_3_CANNODE_0_CanIf2PduR    1
