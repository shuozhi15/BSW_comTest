...
#define PduRConf_PduRSrcPdu_BMS_20_Can_Network_CANNODE_0_Com2PduR    0
#define PduRConf_PduRDestPdu_BMS_20_Can_Network_CANNODE_0_PduR2CanIf  0

#define PduRConf_PduRSrcPdu_BMS_Vol_8_Can_Network_CANNODE_0_Com2PduR    1
#define PduRConf_PduRDestPdu_BMS_Vol_8_Can_Network_CANNODE_0_PduR2CanIf  1

#define PduRConf_PduRSrcPdu_OBC_1_Can_Network_CANNODE_0_CanIf2PduR    0

#define PduRConf_PduRSrcPdu_TMR_3_Can_Network_CANNODE_0_CanIf2PduR    1
