...
/*****************************************************************************************
* Function name :   FUNC(void, BSWM_CODE) BswM_Prv_Action_RbSwcUserCallout( P2VAR(Std_ReturnType, AUTOMATIC, BSWM_APPL_DATA) action_RetVal_pu8,P2CONST(void, AUTOMATIC, BSWM_APPL_CONST) dataActionParameter_pv)
...
* Remarks       :
*****************************************************************************************/
static FUNC(void, BSWM_CODE) BswM_Prv_Action_RbSwcUserCallout( P2VAR(Std_ReturnType, AUTOMATIC, BSWM_APPL_DATA) action_RetVal_pu8, P2CONST(void, AUTOMATIC, BSWM_APPL_CONST) dataActionParameter_pv )
{
#if (defined(BSWM_NO_OF_AC_RB_SWC_USERCALLOUT) && (BSWM_NO_OF_AC_RB_SWC_USERCALLOUT > 0 ))

    P2CONST(BswM_Cfg_AC_RbSwcUserCalloutType_tst, AUTOMATIC,BSWM_APPL_CONST) dataActionPara_pst =  (const BswM_Cfg_AC_RbSwcUserCalloutType_tst *)dataActionParameter_pv;
    /* Initialize to "no return value" */
    *action_RetVal_pu8 = BSWM_NO_RET_VALUE;
