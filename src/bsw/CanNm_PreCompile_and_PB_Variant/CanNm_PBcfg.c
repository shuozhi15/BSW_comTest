...
/*CanNmChannelConfig_NmConfig_0_CanNmCluster_0*/
    {
        ...
        0x0, /* CanNm Node Id              */
        6,  /* User Data Length     */
        10,    /* number of Immediate Nm Pdus     */
