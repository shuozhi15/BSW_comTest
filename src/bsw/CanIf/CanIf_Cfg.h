...
#define CANIF_CFG_TOTAL_HRH_NUM                     1u
...
#define CANIF_CFG_NUM_CANRXPDUIDS_NOT_USER                     1u
...
//#define CANIF_TOTAL_TXPDUS                  1

/*Total number of Tx-Pdus configured in CanIf*/
//#define CANIF_TOTAL_TXBUFFERS               1 


/*Total number of Rx-Pdus configured in CanIf*/
#define CANIF_TOTAL_RXPDUS                  1


/*Number of entries in CanIf_TxPduId_CustId_LUT[][]*/
#define CANIF_NUM_CUSTID_ENTRIES            1
...
#define CanIfConf_CanIfTxPduCfg_BMS_Tem_4_CANNODE_0        0
