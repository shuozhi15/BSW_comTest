 ...
 * Syntax           : FUNC(void, CANIF_CODE) CanIf_XCore_Init(P2CONST(CanIf_XCore_ConfigType, AUTOMATIC, CANIF_APPL_CONST)Config_pcst)
 ...
 * Syntax           : static FUNC(uint32, CANIF_CODE) CanIf_XCore_Pipe_CalcAlignSizeU32W(uint32 LengthBytes_u32)
 ...
 * Syntax           : static FUNC(void, CANIF_CODE) CanIf_XCore_Pipe_Init(uint16 PipeId, P2CONST(CanIf_XCore_ConfigType, AUTOMATIC, CANIF_APPL_CONST)Config_pcst)
 ...
 * Syntax           : static FUNC(void, CANIF_CODE) CanIf_XCore_Pipe_Init(uint16 PipeId)
 ...
 * Syntax           : FUNC(void, CANIF_CODE) CanIf_XCore_PipeWrite(uint16 PipeId, P2CONST(CanIf_XCore_PipeTxRxParams_st, AUTOMATIC, CANIF_APPL_CONST)params_pst))
...
Std_ReturnType CanIf_XCore_PipeWrite(uint16 PipeId, P2VAR(CanIf_XCore_PipeTxRxParams_st, AUTOMATIC, CANIF_APPL_CONST)params_pst)
{
	...
	if(retVal == E_OK)
	{
	    ...
	    /* MR12 RULE Dir-4.6 VIOLATION: Warning is "Not Critical". */
		...
		{
	         /* MR12 RULE Dir-1.1 VIOLATION: Warning is "Not Critical". */
 ...
 * Syntax           : FUNC(void, CANIF_CODE) CanIf_XCore_PipeRead(uint16 PipeId)
 ...
 * Syntax           : static FUNC(void, CANIF_CODE) CanIf_XCore_Pipe_CreatePduPkt(
...
/**********************************************************************************************************************
 * Function name    : CanIf_XCore_Pipe_CreatePduPkt
 * Syntax           : static FUNC(void, CANIF_CODE) CanIf_XCore_Pipe_CreateInvalidPduPkt(
 ...
 * Syntax           : static FUNC(Std_ReturnType, CANIF_CODE) CanIf_XCore_Pipe_PushPduHdrToFifo(
 *                                                            CanIf_XCore_PipeRuntimeInfoType_st *CanIf_XCore_Pipe_pst,
														...
														uint32** PayloadPtr_ppu32, uint32* PayloadLenU32W_pu32)
{
    ...
    *PayloadLenU32W_pu32 = payloadLenU32W;
    ...
    if (CanIf_XCore_Pipe_pst->WritePtr_pv >= CanIf_XCore_Pipe_pst->ReadPtr_pv) /* normal case. no wraparound */
    {
 ...
 * Syntax           : FUNC(void, CANIF_CODE) CanIf_XCore_ClearPipes(VAR(uint8, AUTOMATIC)ControllerId)
 ...
 * Syntax           : FUNC(void, CANIF_CODE) CanIf_XCore_ClearPipepacket( VAR(uint16, AUTOMATIC) PipeId, VAR(uint8, AUTOMATIC)ControllerId)
