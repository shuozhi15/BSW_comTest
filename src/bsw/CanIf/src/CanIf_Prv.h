...
extern VAR(CanIf_Prv_TxBufferStatus_tst, CANIF_VAR) CanIf_Prv_TxBufferRam_ast[];
...
#define CANIF_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
extern VAR(CanIf_Prv_TxPduStatus_tst, CANIF_VAR) CanIf_Prv_TxPduRam_ast[];
#define CANIF_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
...
#define CANIF_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
extern VAR(CanIf_ControllerStateType, CANIF_VAR) CanIf_Prv_ControllerState_ast[];
#define CANIF_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
...
#include "CanIf_MemMap.h"
extern VAR(boolean, CANIF_VAR) CanIf_Prv_InitStatus_b;
...
#define CANIF_START_SEC_CONST_UNSPECIFIED
#include "CanIf_MemMap.h"
extern CONST(CanIf_RxCbk_Prototype, CANIF_CONST) CanIf_Prv_ULName_ta_fct[];
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
#include "CanIf_MemMap.h"
...
#define CANIF_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
extern VAR(CanIf_NotifStatusType, CANIF_VAR) CanIf_Prv_TxNotification_aen[];
#define CANIF_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
#endif
...
#define CANIF_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
extern VAR(CanIf_NotifStatusType, CANIF_VAR) CanIf_Prv_RxNotification_taen[CANIF_CFG_NUM_CANRXPDUIDS];
#define CANIF_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
#endif
...
#include "CanIf_MemMap.h"
extern VAR(uint8, CANIF_VAR) CanIf_Prv_RxBuffer_tau8[CANIF_CFG_RX_BUFFER_SIZE];
...
#include "CanIf_MemMap.h"
extern P2CONST(CanIf_ConfigType, AUTOMATIC, AUTOMATIC) CanIf_Prv_ConfigSet_pcst;
 ...
 */
#define CANIF_STATIC                           (PduIdType)(((uint32)1u << (uint8)((uint8)8u * (uint8)sizeof(PduIdType)))-1u)/*(PduIdType)((1u << (8u * (uint8)sizeof(PduIdType)))-1u)*/
...
#define CANIF_START_SEC_CODE
#include "CanIf_MemMap.h"
extern FUNC(void, CANIF_CODE) CanIf_Prv_BufferInit(void);
#define CANIF_STOP_SEC_CODE
#include "CanIf_MemMap.h"

#define CANIF_START_SEC_CODE
#include "CanIf_MemMap.h"
extern FUNC(Std_ReturnType, CANIF_CODE) CanIf_Prv_WriteTxBuffer
...
#define CANIF_START_SEC_CODE
#include "CanIf_MemMap.h"
extern FUNC(Std_ReturnType, CANIF_CODE) CanIf_Prv_ReadTxBuffer(
...
#define CANIF_START_SEC_CODE
#include "CanIf_MemMap.h"
extern FUNC(void , CANIF_CODE) CanIf_Prv_ClearTxChannelBuffer(VAR(uint8, AUTOMATIC)ControllerId);
#define CANIF_STOP_SEC_CODE
#include "CanIf_MemMap.h"
...
extern FUNC(void, CANIF_CODE) CanIf_Prv_WriteRxBuffer(P2CONST (uint8, AUTOMATIC, CANIF_APPL_CONST) CanSduPtr,
...
#define CANIF_START_SEC_VAR_FAST_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
extern P2CONST(CanIf_ConfigType, AUTOMATIC, AUTOMATIC) CanIf_Prv_ConfigSet_tpst;
#define CANIF_STOP_SEC_VAR_FAST_CLEARED_UNSPECIFIED
#include "CanIf_MemMap.h"
