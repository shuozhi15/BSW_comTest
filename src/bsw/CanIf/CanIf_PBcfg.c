...
/*BMS_Tem_5_Can_Network_CANNODE_0*/

{ /*CanIf_TxBufferConfigPtr*/&CanIf_TxBufferGen_a[CanIf_Buffer_CustId_Buffer_Can_Network_CANNODE_0_Tx_Std_MailBox_1],    /*TxPduId*/CanIfConf_CanIfTxPduCfg_BMS_Tem_5_Can_Network_CANNODE_0, /*TxPduTargetPduId*/ 0 , 
/*TxPduType*/CANIF_STATIC, /*TxPduCanIdType*/STANDARD_CAN,   /*TxPduTxUserUL*/PDUR,      /*UserTxConfirmation*/&PduR_CanIfTxConfirmation, /*TxPduCanId*/ 0x564   , /*TxPduReadNotifyStatus*/ FALSE    ,/*TxTruncEnabled*/ FALSE,/*TxPduLength*/8u}
,

/*NMm_BMS_Can_Network_CANNODE_0*/

{ /*CanIf_TxBufferConfigPtr*/&CanIf_TxBufferGen_a[CanIf_Buffer_CustId_Buffer_Can_Network_CANNODE_0_Tx_Std_MailBox_2],    /*TxPduId*/CanIfConf_CanIfTxPduCfg_NMm_BMS_Can_Network_CANNODE_0, /*TxPduTargetPduId*/ 0 , 
...
static CONST(CanIf_Cfg_Hrhtype_tst, CANIF_CONST) CanIf_Prv_HrhConfig_tacst[2] =
{
...
#define CANIF_START_SEC_CONST_UNSPECIFIED
#include "CanIf_MemMap.h"
static CONST(CanIf_Cfg_RxPduType_tst, CANIF_CONST) CanIf_Prv_RxPduConfig_tacst[2]=
{   
   /*RxPduReadNotifyStatus_b       IndexForUL_u8   CanIdtype_u8    RxPduDlc_u8      RxPduCanId      Hrhref_t    RxPduTargetId_t 	*/
    ...
    {
        CANIF_READ_NOTIFSTATUS,     1u,           0x20u,            8u,         1583u,       0,         0,            },
    /*OBC_4_Can_Network_CANNODE_0*/
    {
        CANIF_READ_NOTIFSTATUS,     6u,           0x20u,            8u,         1084u,       1,         PduRConf_PduRSrcPdu_OBC_4_Can_Network_CANNODE_0_CanIf2PduR,            }
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
#include "CanIf_MemMap.h"
