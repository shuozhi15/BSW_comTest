...
/*BMS_14_Can_Network_CANNODE_0*/

{ /*CanIf_TxBufferConfigPtr*/&CanIf_TxBufferGen_a[CanIf_Buffer_CustId_Buffer_Can_Network_CANNODE_0_Tx_Std_MailBox_1],    /*TxPduId*/CanIfConf_CanIfTxPduCfg_BMS_14_Can_Network_CANNODE_0, /*TxPduTargetPduId*/ 0 , 
/*TxPduType*/CANIF_STATIC, /*TxPduCanIdType*/STANDARD_CAN,   /*TxPduTxUserUL*/PDUR,      /*UserTxConfirmation*/&PduR_CanIfTxConfirmation, /*TxPduCanId*/ 0x5AC   , /*TxPduReadNotifyStatus*/ FALSE    ,/*TxTruncEnabled*/ FALSE,/*TxPduLength*/8u}
};
...
static CONST(CanIf_Cfg_Hrhtype_tst, CANIF_CONST) CanIf_Prv_HrhConfig_tacst[1] =
{
...
#define CANIF_START_SEC_CONST_UNSPECIFIED
#include "CanIf_MemMap.h"
static CONST(CanIf_Cfg_RxPduType_tst, CANIF_CONST) CanIf_Prv_RxPduConfig_tacst[1]=
{   
...
CONST(CanIf_ConfigType, CANIF_CONST) CanIf_Config =
{
   ...
   1,      /*CANIF TOTAL TXPDUS for this variant*/
   1,        /*CANIF_TOTAL_TXBUFFERS for this variant*/
