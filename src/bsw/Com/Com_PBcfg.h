...
#define COM_NUM_RX_SIGNALS        7u
#define COM_NUM_TX_SIGNALS        9u
#define COM_NUM_TX_IPDU         2u
#define COM_NUM_RX_IPDU         2u
...
#define COM_NUM_IPDUS_IN_LAST_IPDUGRP 2u
...
extern VAR(uint8,COM_VAR) Com_IpduBuf_BMS_20_Can_Network_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_IpduBuf_BMS_Vol_8_Can_Network_CANNODE_0[];
...
extern VAR(uint8,COM_VAR) Com_LocalBuf_OBC_1_Can_Network_CANNODE_0[];
