...
#define COM_NUM_RX_SIGNALS        6u
#define COM_NUM_TX_SIGNALS        4u
...
extern VAR(uint8,COM_VAR) Com_IpduBuf_BMS_Vol_5_CANNODE_0[];
...
extern VAR(uint8,COM_VAR) Com_LocalBuf_OBC_4_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_LocalBuf_TMR_3_CANNODE_0[];
