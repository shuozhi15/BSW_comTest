...
CONST(Com_Prv_xTxSigCfg_tst ,COM_CONST) Com_Prv_xTxSigCfg_acst[COM_NUM_TX_SIGNALS] =
{
    ...
    {  /* BMS_BattCellOrder20Vol */
        ...
        (Com_IpduIdType)ComConf_ComIPdu_Internal_BMS_Vol_5_CANNODE_0,             /*Ipdu Reference*/
        /*
        {
            Type:5;       = UINT16
...
{    
    ...
    {  /* OBC_ChargeSourceMode */
      ...
      2, /*BitSize*/
       ...
       (Com_IpduIdType)ComConf_ComIPdu_Internal_OBC_4_CANNODE_0,                       /*Ipdu Reference*/
        /*
        {
            Type:5;        = UINT8
            Endianess:1;   = BIG_ENDIAN
    ...
    {  /* TMR_VoltageHV */
      ...
      10, /*BitSize*/
       ...
       (Com_IpduIdType)ComConf_ComIPdu_Internal_TMR_3_CANNODE_0,                       /*Ipdu Reference*/
        /*
        {
            Type:5;        = UINT16
            Endianess:1;   = BIG_ENDIAN
...
/* BMS_Vol_5_CANNODE_0 has a TMS switch */
static CONST(Com_TransModeInfo ,COM_CONST) Com_BMS_Vol_5_CANNODE_0_TransModeInfo[] =
{
...
{
    {   /*Ipdu: BMS_Vol_5_CANNODE_0*/

        Com_IpduBuf_BMS_Vol_5_CANNODE_0,              /*Pointer to the Ipdu Buffer*/

        
        Com_BMS_Vol_5_CANNODE_0_TransModeInfo,
        ...
        (PduIdType)PduRConf_PduRSrcPdu_BMS_Vol_5_CANNODE_0_Com2PduR,              /* PduR Id */

        (Com_TxIntSignalIdType)ComSignal_Internal_BMS_BattCellOrder20Vol,     /*Index to First Signal within this Ipdu*/
        #ifdef COM_TX_SIGNALGROUP
...
{
    {   /*Ipdu: OBC_4_CANNODE_0*/
        

        Com_LocalBuf_OBC_4_CANNODE_0,              /*Pointer to the Local Ipdu Buffer*/
    ...
    {   /*Ipdu: TMR_3_CANNODE_0*/
        

        Com_LocalBuf_TMR_3_CANNODE_0,              /*Pointer to the Local Ipdu Buffer*/
...
CONST(Com_IpduIdType ,COM_CONST) Com_Prv_xIPduGrp_IpduRefCfg_au8[3] =
{

    /* ComIPduGroup_Rx */

    ComConf_ComIPdu_Internal_OBC_4_CANNODE_0,
    ComConf_ComIPdu_Internal_TMR_3_CANNODE_0,
    /* ComIPduGroup_Tx */

    (COM_NUM_RX_IPDU + (Com_IpduIdType)ComConf_ComIPdu_Internal_BMS_Vol_5_CANNODE_0)
};
...
#include "Com_MemMap.h"
    ...
    VAR(uint8,COM_VAR) Com_IpduBuf_BMS_Vol_5_CANNODE_0[8];
...
#include "Com_MemMap.h"
    ...
    VAR(uint8,COM_VAR) Com_LocalBuf_OBC_4_CANNODE_0[8];

    VAR(uint8,COM_VAR) Com_LocalBuf_TMR_3_CANNODE_0[8];
...
VAR(uint16,COM_VAR) Com_SigType_u16[4];
