...
CONST(Com_Prv_xTxSigCfg_tst ,COM_CONST) Com_Prv_xTxSigCfg_acst[COM_NUM_TX_SIGNALS] =
{
    ...
    {  /* BMS_BattTempSensorOrder32 */
        ...
        (Com_IpduIdType)ComConf_ComIPdu_Internal_BMS_Tem_4_CANNODE_0,             /*Ipdu Reference*/
        /*
        {
            Type:5;       = UINT8
...
/* BMS_Tem_4_CANNODE_0 has a TMS switch */
static CONST(Com_TransModeInfo ,COM_CONST) Com_BMS_Tem_4_CANNODE_0_TransModeInfo[] =
{
...
{
    {   /*Ipdu: BMS_Tem_4_CANNODE_0*/

        Com_IpduBuf_BMS_Tem_4_CANNODE_0,              /*Pointer to the Ipdu Buffer*/

        
        Com_BMS_Tem_4_CANNODE_0_TransModeInfo,
        ...
        (PduIdType)PduRConf_PduRSrcPdu_BMS_Tem_4_CANNODE_0_Com2PduR,              /* PduR Id */

        (Com_TxIntSignalIdType)ComSignal_Internal_BMS_BattTempSensorOrder32,     /*Index to First Signal within this Ipdu*/
        #ifdef COM_TX_SIGNALGROUP
...
CONST(Com_IpduIdType ,COM_CONST) Com_Prv_xIPduGrp_IpduRefCfg_au8[2] =
{
    ...
    (COM_NUM_RX_IPDU + (Com_IpduIdType)ComConf_ComIPdu_Internal_BMS_Tem_4_CANNODE_0)
};
...
#include "Com_MemMap.h"
    ...
    VAR(uint8,COM_VAR) Com_IpduBuf_BMS_Tem_4_CANNODE_0[8];
