 ...
 * typedef struct \n
 * { \n
 *     unsigned int isEventTrig                   : 1; Set, If the call to Com_Prv_SendIpdu is from Event/Proc function
 *                                                     i.e., apart from Com_MainFunctionTx. \n
 ...
 *     unsigned int sigTransProp                  : 1; Set, If signal transfer property is triggered(1)/pending(0) \n
 *     unsigned int isTimeoutReq                  : 1; Set, If Timeout monitoring is required \n
 *     unsigned int ignoreRepetitions             : 1; Set, If configured repetitions are to be ignored \n
 * } Com_SendIpduInfo; \n
 *
 * IMPORTANT NOTE!!
 * If new bitfields are added here, make sure to add same number of initialize('0') bits in
 ...
 *      uint16                  txSignalFields;     Signal Property\n
 *
 ...
 *      P2FUNC(boolean, COM_APPL_CODE, CallOut)(PduIdType, P2VAR(PduInfoType, TYPEDEF, COM_APPL_DATA)); Ipdu Callout Function\n
 *   #endif\n
 *   #ifdef COM_TxIPduNotification\n
 ...
 *   #endif\n
 *      uint16                  txIPduFields;       Transmission Type\n
 *      Com_MainFuncType        MainFunctionRef;    MainFunction Number to which this IPdu belongs to\n
...
typedef struct
{
    ...
    uint16 defaultTMSStatus:1;          Set, if Ipdu is not referring to any IpduGroup,
                                             and the filter evaluation during the configuration time resulted in true
 ...
 *      P2FUNC(boolean, COM_APPL_CODE, CallOut)(PduIdType, P2CONST(PduInfoType, TYPEDEF, COM_APPL_CONST)); Ipdu Callout Function\n
 *   #endif\n
 *   #ifdef COM_RxIPduTimeoutNotify\n
 *      P2FUNC(void, COM_APPL_CODE, TimeOutNotification_Cbk)(void); Timeout Notification part\n
 *   #endif\n
 *   #ifdef COM_RxIPduNotification\n
 *      P2FUNC(void, COM_APPL_CODE, Notification_Cbk)(void);    Notification callback function for IPDU. This function is generated through code generator\n
 *   #endif\n
 *      uint16                          Size;                   Size in Bits\n
 ...
 *   #endif\n
 *      Com_MainFuncType                MainFunctionRef;        MainFunction Number to which this IPdu belongs to\n
 *      uint8                           rxIPduFields;           Reception IPdu Type\n
 *
 ...
 *      uint16      NoOfRxPdus;          No. of ipdus in a particular group\n
...
typedef struct
{
    ...
    typedef struct
    {
        ...
        uint16 isLargeDataPduFlag:1;   Flag which stores information if the Tp Pdu buffer is locked or unlocked.
        uint16 GwTMSChanged:1;         Flag is set, if the Gw-IPDU's Tranmission Mode has changed after its last
                                               transmission from Com
        uint16 RetryFailedTxReq:1;     Set, if failed Tx-Req are to be retried in the next Com_MainFunctionTx
        uint16 Not_Used:5;             Un-used bits
    } Com_TxFlagsType;
    */
    /* FC_VariationPoint_END */
    uint16              Com_TxFlags;
 ...
 *   #endif\n
 *      uint8               RxFlags;            Variable to hold the Rx flags
 * }Com_RxIpduRamData;
 */
typedef struct
{
...
typedef struct
{
    ...
    P2CONST(Com_Prv_xRxRamBuf_tst, COM_CONST, COM_APPL_CONST)             Com_RxRamBuf_pcst;

#ifdef COM_TX_SIGNALGROUP
    P2CONST(Com_Prv_xTxSigGrpRamBuf_tst, COM_CONST, COM_APPL_CONST)       Com_TxSigGrpRamBuf_pcst;
#endif
