...
/***************************************************************************************************
 ...
 Syntax           : Com_SigMaxType Com_UnpackSignal( VAR(uint8, AUTOMATIC)                    Endianess,
 ...
 Parameter        : Endianess - Little/Big Endian
                    Bit_Pos   - Signal Bit position
                    Bitsize   - Signal Bit size
                    *Src_Buf  - IPdu buffer
                    IsSigned  - Is Signal of signed type
 Return value     : Com_SigMaxType - return unpack signal value
 ***************************************************************************************************/
                                                 ...
                                                 VAR(boolean, AUTOMATIC)                  IsSigned )
{
    ...
    return(a_data); /* Return the Unpacked data */
}
                ...
                P2CONST(uint8,AUTOMATIC,COM_APPL_DATA) Src_Buf)
{
    ...
    if(BitOffsetInByte ==  (uint8_least)0)
    {
        if(Endianess == COM_LITTLEENDIAN)
        {
            ...
            (void)rba_BswSrv_MemCopy( (void *)destdata_u8, (const void *)(Src_Buf+ByteNo), NoofBytes );
