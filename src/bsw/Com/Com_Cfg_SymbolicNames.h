...
/* Tx IPdus */
        #define ComConf_ComIPdu_BMS_Vol_5_CANNODE_0 0
    /* Rx IPdus */
        #define ComConf_ComIPdu_OBC_4_CANNODE_0 0
        #define ComConf_ComIPdu_TMR_3_CANNODE_0 1
...
/* Signal IDs*/
/* Tx Signal ID*/
    #define ComConf_ComSignal_BMS_BattCellOrder20Vol 0
    #define ComConf_ComSignal_BMS_BattCellOrder19Vol 1
    #define ComConf_ComSignal_BMS_BattCellOrder18Vol 2
    #define ComConf_ComSignal_BMS_BattCellOrder17Vol 3
...
/* Rx Signal ID*/
    ...
    #define ComConf_ComSignal_TMR_VoltageHV 4
    #define ComConf_ComSignal_TMR_CurrentHV 5
