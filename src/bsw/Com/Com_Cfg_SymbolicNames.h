...
/* Tx IPdus */
        #define ComConf_ComIPdu_BMS_14_Can_Network_CANNODE_0 0
    /* Rx IPdus */
        #define ComConf_ComIPdu_TMR_3_Can_Network_CANNODE_0 0
...
/* Signal IDs*/
/* Tx Signal ID*/
    #define ComConf_ComSignal_BMS_SubsymCodeOrder12 0
    #define ComConf_ComSignal_BMS_SubsymCodeOrder11 1
    #define ComConf_ComSignal_BMS_SubsymCodeOrder10 2
    #define ComConf_ComSignal_BMS_SubsymCodeOrder9 3
    #define ComConf_ComSignal_BMS_SubsymCodeOrder8 4
    #define ComConf_ComSignal_BMS_SubsymCodeOrder7 5
    #define ComConf_ComSignal_BMS_SubsymCodeFrameTotalNum 6
    #define ComConf_ComSignal_BMS_SubsymCodeFrameOrder2 7
