...
typedef CanIf_NotifStatusType_Enum_impl CanIf_NotifStatusType_Aenum_impl[2];
...
typedef Com_impl_u8 Com_SigBuf_au8_impl[2];
...
typedef P2FUNC(VAR(Std_ReturnType, AUTOMATIC), RTE_CODE, Rte_ImplWriteFP_swc_soc_DataElements_VariableDataPrototype_0) (VAR(uint16, AUTOMATIC) data);
